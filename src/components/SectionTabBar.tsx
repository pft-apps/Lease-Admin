...
export const SectionTabBar: React.FC<SectionTabBarProps> = ({
  ...
  return (
    <div id="section-tabs" className="bg-[#06234D] text-white rounded-2xl border border-[#00C4E7]/30 p-4 mb-8 space-y-4 font-sans relative">
      {/* Header Info */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-1 pt-1 pb-3 border-b border-[#00C4E7]/20 gap-3">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#00C4E7] text-[#06234D] flex items-center justify-center font-black text-sm">
            <i className="fa-solid fa-folder-open"></i>
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-sm font-black tracking-wide text-white">Dashboard Module Views</h3>
              <span className="text-[10px] font-extrabold uppercase px-2 py-0.5 rounded bg-[#00C4E7]/15 text-[#00C4E7] border border-[#00C4E7]/25">
                Folder Navigation
              </span>
            </div>
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto text-xs font-bold text-slate-200 bg-[#001D45] px-3 py-1 rounded-full border border-[#00C4E7]/30">
          <span className="w-2 h-2 rounded-full bg-[#00C4E7]"></span>
          <span className="text-slate-400">Active Module:</span>
          <strong className="text-white uppercase font-black tracking-wider">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-1.5 px-2 py-2 sm:py-2.5 rounded-xl text-[11px] xl:text-xs font-bold transition-all cursor-pointer border select-none w-full ${
                isActive
                  ? 'bg-white text-[#06234D] border-white font-black'
                  : 'bg-[#001D45] hover:bg-[#002D68] text-slate-200 hover:text-white border-[#00C4E7]/25'
              }`}
            >
              ...
              {tab.badge && (
                <span
                  className={`hidden xl:inline-block text-[9px] px-1.5 py-0.2 rounded font-extrabold tracking-tighter shrink-0 ${
                    isActive
                      ? 'bg-[#06234D] text-white'
